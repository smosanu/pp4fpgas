...
\begin{figure}
{\tiny \lstinputlisting[format=none, lastline=43]{examples/huffman_encoding.cpp}}
\end{figure}
\begin{figure}
{\tiny \lstinputlisting[format=none,firstline=44]{examples/huffman_encoding.cpp}}
...
\begin{figure}
{\tiny \lstinputlisting[lastline=40]{examples/huffman.h}}
...
\begin{figure}
{\tiny \lstinputlisting[format=none, lastline=39]{examples/huffman_sort.cpp}}
\end{figure}
\begin{figure}
{\tiny \lstinputlisting[format=none,firstline=40]{examples/huffman_sort.cpp}}
...
\begin{figure}
{\tiny \lstinputlisting[format=none]{examples/huffman_compute_bit_length.cpp}}
...
\begin{figure}
{\tiny \lstinputlisting[lastline=39]{examples/huffman_truncate_tree.cpp}}
\end{figure}
\begin{figure}
{\footnotesize \lstinputlisting[format=none, firstline=40]{examples/huffman_truncate_tree.cpp}}
...
\begin{figure}
{\tiny \lstinputlisting[firstline=1]{examples/huffman_canonize_tree.cpp}}
